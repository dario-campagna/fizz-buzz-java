...
public class PrintNumbersTest {
    ...
    public void printOneToFifteenWithFizzBuzz() {
        ConsoleGameFactory.createConsoleFizzBuzz().play(IntStream.rangeClosed(1,15));
    ...
    public void printThirtyToThirtyFiveWithFizzBuzzBang() {
        ConsoleGameFactory.createConsoleFizzBuzzBang().play(IntStream.rangeClosed(30,35));
    ...
    public void printOneHundredToOneHundredAndFiveWithFizzBuzzBang() {
        ConsoleGameFactory.createConsoleFizzBuzzBang().play(IntStream.rangeClosed(100,105));
